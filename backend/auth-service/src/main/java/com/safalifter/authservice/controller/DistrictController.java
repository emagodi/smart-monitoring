...
public class DistrictController {
    ...
    @PreAuthorize("(hasAuthority('districts.create') or hasAuthority('WRITE_PRIVILEGE')) and hasAnyRole('ADMIN','ADMINISTRATOR','DEPOT_FOREMAN','TECHNICIAN','MANAGINGDIRECTOR','DISTRICTMANAGER','FINANCEDIRECTOR','TECHNICALDIRECTOR','COMMERCIALDIRECTOR','BUSINESSMANAGER','USER')")
    ...
    @PreAuthorize("(hasAuthority('districts.read') or hasAuthority('READ_PRIVILEGE')) and hasAnyRole('ADMIN','ADMINISTRATOR','DEPOT_FOREMAN','TECHNICIAN','MANAGINGDIRECTOR','DISTRICTMANAGER','FINANCEDIRECTOR','TECHNICALDIRECTOR','COMMERCIALDIRECTOR','BUSINESSMANAGER','USER')")
    ...
    @PreAuthorize("(hasAuthority('districts.update') or hasAuthority('UPDATE_PRIVILEGE')) and hasAnyRole('ADMIN','ADMINISTRATOR','DEPOT_FOREMAN','TECHNICIAN','MANAGINGDIRECTOR','DISTRICTMANAGER','FINANCEDIRECTOR','TECHNICALDIRECTOR','COMMERCIALDIRECTOR','BUSINESSMANAGER','USER')")
    ...
    @PreAuthorize("(hasAuthority('districts.delete') or hasAuthority('DELETE_PRIVILEGE')) and hasAnyRole('ADMIN','ADMINISTRATOR','DEPOT_FOREMAN','TECHNICIAN','MANAGINGDIRECTOR','DISTRICTMANAGER','FINANCEDIRECTOR','TECHNICALDIRECTOR','COMMERCIALDIRECTOR','BUSINESSMANAGER','USER')")
