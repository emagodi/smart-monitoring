...
public class DepotController {
    ...
    @PreAuthorize("(hasAuthority('depots.create') or hasAuthority('WRITE_PRIVILEGE')) and hasAnyRole('ADMIN','ADMINISTRATOR','DEPOT_FOREMAN','TECHNICIAN','MANAGINGDIRECTOR','DISTRICTMANAGER','FINANCEDIRECTOR','TECHNICALDIRECTOR','COMMERCIALDIRECTOR','BUSINESSMANAGER','USER')")
    ...
    @PreAuthorize("(hasAuthority('depots.read') or hasAuthority('READ_PRIVILEGE')) and hasAnyRole('ADMIN','ADMINISTRATOR','DEPOT_FOREMAN','TECHNICIAN','MANAGINGDIRECTOR','DISTRICTMANAGER','FINANCEDIRECTOR','TECHNICALDIRECTOR','COMMERCIALDIRECTOR','BUSINESSMANAGER','USER')")
    ...
    @PreAuthorize("(hasAuthority('depots.update') or hasAuthority('UPDATE_PRIVILEGE')) and hasAnyRole('ADMIN','ADMINISTRATOR','DEPOT_FOREMAN','TECHNICIAN','MANAGINGDIRECTOR','DISTRICTMANAGER','FINANCEDIRECTOR','TECHNICALDIRECTOR','COMMERCIALDIRECTOR','BUSINESSMANAGER','USER')")
    ...
    @PreAuthorize("(hasAuthority('depots.delete') or hasAuthority('DELETE_PRIVILEGE')) and hasAnyRole('ADMIN','ADMINISTRATOR','DEPOT_FOREMAN','TECHNICIAN','MANAGINGDIRECTOR','DISTRICTMANAGER','FINANCEDIRECTOR','TECHNICALDIRECTOR','COMMERCIALDIRECTOR','BUSINESSMANAGER','USER')")
